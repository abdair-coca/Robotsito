...
def main() -> None:
    ...
    print('═' * 50)
    print('  W=adelante  S=atrás  A=izq  D=der  ESPACIO=parar  Q=salir')
    ...
    try:
        while True:
            ...
            if k == 'q':
                ...
                izq, der = 1, 1;   print('adelante')
            elif k == 's':
                izq, der = -1, -1; print('atrás')
            elif k == 'a':
                izq, der = -1, 1;  print('izquierda')
            elif k == 'd':
                izq, der = 1, -1;  print('derecha')
            elif k == ' ':
                izq, der = 0, 0;   print('parar')
